...
const campusZones: {
  ...
  {
    // Siebel [-88.2244, 40.1140] + Grainger [-88.2269, 40.1125] — N of Green
    id: 'eng', name: 'Engineering', nameEn: 'Grainger College', color: '#3b82f6',
    center: [-88.2260, 40.1132],
    coords: [
      [-88.2315, 40.1094],
      [-88.2298, 40.1091],
      [-88.2278, 40.1090],
  ...
  {
    // Altgeld [-88.2284,40.1093] + Lincoln [-88.2282,40.1066] + Noyes [-88.2261,40.1084]
    id: 'las', name: 'LAS', nameEn: 'Liberal Arts & Sciences', color: '#a855f7',
    center: [-88.2276, 40.1076],
    coords: [
      [-88.2312, 40.1053],
      [-88.2296, 40.1047],
      [-88.2278, 40.1045],
  ...
  {
    // Krannert [-88.2309,40.1022] + Harding Band [-88.2308,40.1048] — SW campus
    id: 'art', name: 'FAA', nameEn: 'Fine & Applied Arts', color: '#0ea5e9',
    center: [-88.2312, 40.1040],
    coords: [
      [-88.2348, 40.1014],
      [-88.2330, 40.1009],
      [-88.2310, 40.1011],
