...
const campusZones: {
  ...
  {
    // Siebel [-88.2244, 40.1140] + Grainger Lib [-88.2269, 40.1125] — N of Green St
    id: 'eng', name: 'Engineering', nameEn: 'Grainger College', color: '#3b82f6',
    center: [-88.2258, 40.1132],
    coords: [
      [-88.2315, 40.1095],
      [-88.2272, 40.1093],
      [-88.2248, 40.1097],
  ...
  {
    // BIF [-88.2306, 40.1036] — SW campus, west of Wright
    id: 'bus', name: 'Business', nameEn: 'Gies College', color: '#16a34a',
    center: [-88.2315, 40.1025],
    coords: [
      [-88.2355, 40.0992],
      [-88.2315, 40.0988],
      [-88.2285, 40.0995],
  ...
  {
    // Turner Hall — east of Wright, south campus
    id: 'agr', name: 'ACES', nameEn: 'Agricultural Sciences', color: '#f97316',
    center: [-88.2235, 40.1005],
    coords: [
      [-88.2272, 40.0978],
      [-88.2245, 40.0972],
      [-88.2215, 40.0975],
  ...
  {
    // Gregory Hall [-88.2281, 40.1057] — compact media zone
    id: 'med', name: 'Media', nameEn: 'College of Media', color: '#ec4899',
    center: [-88.2282, 40.1058],
    coords: [
      [-88.2298, 40.1044],
      [-88.2278, 40.1040],
      [-88.2262, 40.1046],
